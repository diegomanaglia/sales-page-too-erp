            ...
            <Container>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div>
                        ...
                        >
                            Um vislumbre do sistema
                        </div>
                        <h3 className="mt-4 text-2xl font-semibold">
                            Fechamento de OS com cálculo automático
                        </h3>
                        <p className="mt-3 text-brand-secondary">
                            Nossa proposta é que você consiga finalizar serviços sem calculadoras ou planilhas. Tudo integrado: peças usadas, descontos e relatório do financeiro.
                        </p>
